...
-- WhatsApp session/message tables are intentionally service-role only. They are
-- written by the signed Meta webhook after HMAC validation, never by browsers.
