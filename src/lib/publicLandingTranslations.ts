...
const hi: PublicLandingCopy = {
  ...
  lifecycleKicker: 'एक जुड़ा हुआ ऑर्डर जीवनचक्र', lifecycleTitle: 'उत्पाद खोज से भुगतान किए गए फ़ुलफ़िलमेंट तक, संदर्भ खोए बिना।', lifecycleCopy: 'हर महत्वपूर्ण चरण वास्तविक ऑर्डर से जुड़ा रहता है: स्टॉक आरक्षण, Razorpay कैप्चर, इनवॉइस, शिपमेंट, ट्रैकिंग और सहायता।', lifecycleStepOne: 'लाइव उत्पाद खोजें या सोर्सिंग आवश्यकता पोस्ट करें।', lifecycleStepTwo: 'तुरंत खरीदें — स्टॉक तुरंत आपके लिए आरक्षित हो जाता है।', lifecycleStepThree: 'सत्यापित भुगतान के बाद इनवॉइस, कमाई और फ़ुलफ़िलमेंट सक्रिय होते हैं।',
  capabilities: [
  ...
  trustItems: [
    ...
    { title: 'सुरक्षित भुगतान', copy: 'स्टॉक आरक्षण के बाद सर्वर द्वारा सत्यापित Razorpay भुगतान।' },
...
const bn: PublicLandingCopy = {
  ...
  lifecycleKicker: 'সংযুক্ত অর্ডার জীবনচক্র', lifecycleTitle: 'পণ্য খোঁজা থেকে পরিশোধিত ফুলফিলমেন্ট পর্যন্ত—প্রাসঙ্গিক তথ্য হারানো ছাড়া।', lifecycleCopy: 'প্রতিটি গুরুত্বপূর্ণ ধাপ আসল অর্ডারের সঙ্গে যুক্ত থাকে: স্টক সংরক্ষণ, Razorpay ক্যাপচার, ইনভয়েস, শিপমেন্ট, ট্র্যাকিং ও সহায়তা।', lifecycleStepOne: 'লাইভ পণ্য খুঁজুন অথবা সোর্সিং প্রয়োজন পোস্ট করুন।', lifecycleStepTwo: 'সঙ্গে সঙ্গে কিনুন — স্টক তখনই আপনার জন্য সংরক্ষিত হয়।', lifecycleStepThree: 'যাচাইকৃত পেমেন্টের পর ইনভয়েস, আয় ও ফুলফিলমেন্ট সক্রিয় হয়।',
  capabilities: [
  ...
  trustItems: [
    ...
    { title: 'সুরক্ষিত পেমেন্ট', copy: 'স্টক সংরক্ষণের পরে সার্ভার-যাচাইকৃত Razorpay পেমেন্ট।' },
...
const mr: PublicLandingCopy = {
  ...
  lifecycleKicker: 'जोडलेले ऑर्डर जीवनचक्र', lifecycleTitle: 'उत्पादन शोधापासून भरलेल्या फुलफिलमेंटपर्यंत—संदर्भ न गमावता.', lifecycleCopy: 'प्रत्येक महत्त्वाचा टप्पा मूळ ऑर्डरशी जोडलेला राहतो: स्टॉक राखीव, Razorpay कॅप्चर, इनव्हॉइस, शिपमेंट, ट्रॅकिंग आणि सहाय्य.', lifecycleStepOne: 'लाइव्ह उत्पादन शोधा किंवा सोर्सिंगची गरज पोस्ट करा.', lifecycleStepTwo: 'लगेच खरेदी करा — स्टॉक तत्काळ तुमच्यासाठी राखून ठेवला जातो.', lifecycleStepThree: 'सत्यापित पेमेंटनंतर इनव्हॉइस, कमाई आणि फुलफिलमेंट सुरू होते.',
  capabilities: [
  ...
  trustItems: [
    ...
    { title: 'सुरक्षित पेमेंट', copy: 'स्टॉक राखीवनंतर सर्व्हर-सत्यापित Razorpay पेमेंट.' },
...
const gu: PublicLandingCopy = {
  ...
  lifecycleKicker: 'જોડાયેલ ઓર્ડર જીવનચક્ર', lifecycleTitle: 'પ્રોડક્ટ શોધથી ચૂકવાયેલા ફુલફિલમેન્ટ સુધી—સંદર્ભ ગુમાવ્યા વગર.', lifecycleCopy: 'દરેક મહત્વપૂર્ણ પગલું મૂળ ઓર્ડર સાથે જોડાયેલ રહે છે: સ્ટોક અનામત, Razorpay કૅપ્ચર, ઇન્વૉઇસ, શિપમેન્ટ, ટ્રૅકિંગ અને સહાય.', lifecycleStepOne: 'લાઇવ પ્રોડક્ટ શોધો અથવા સોર્સિંગ જરૂરિયાત પોસ્ટ કરો.', lifecycleStepTwo: 'તરત જ ખરીદો — સ્ટોક તરત જ તમારા માટે અનામત રાખવામાં આવે છે.', lifecycleStepThree: 'ચકાસાયેલ ચુકવણી પછી ઇન્વૉઇસ, કમાણી અને ફુલફિલમેન્ટ સક્રિય થાય છે.',
  capabilities: [
  ...
  trustItems: [
    ...
    { title: 'સુરક્ષિત ચુકવણી', copy: 'સ્ટોક અનામત પછી સર્વર-ચકાસાયેલ Razorpay ચુકવણી.' },
...
const kn: PublicLandingCopy = {
  ...
  lifecycleKicker: 'ಸಂಪರ್ಕಿತ ಆರ್ಡರ್ ಜೀವನಚಕ್ರ', lifecycleTitle: 'ಉತ್ಪನ್ನ ಹುಡುಕಾಟದಿಂದ ಪಾವತಿಸಿದ ಫುಲ್ಫಿಲ್ಮೆಂಟ್‌ವರೆಗೆ—ಸಂದರ್ಭ ಕಳೆದುಕೊಳ್ಳದೆ.', lifecycleCopy: 'ಪ್ರತಿ ಪ್ರಮುಖ ಹಂತವೂ ನೈಜ ಆರ್ಡರ್‌ಗೆ ಜೋಡಿತವಾಗಿರುತ್ತದೆ: ಸ್ಟಾಕ್ ಕಾಯ್ದಿರಿಸುವಿಕೆ, Razorpay ಕ್ಯಾಪ್ಚರ್, ಇನ್‌ವಾಯ್ಸ್, ಶಿಪ್ಮೆಂಟ್, ಟ್ರ್ಯಾಕಿಂಗ್ ಮತ್ತು ಬೆಂಬಲ.', lifecycleStepOne: 'ಲೈವ್ ಉತ್ಪನ್ನ ಹುಡುಕಿ ಅಥವಾ ಸೋರ್ಸಿಂಗ್ ಅಗತ್ಯ ಪೋಸ್ಟ್ ಮಾಡಿ.', lifecycleStepTwo: 'ತಕ್ಷಣ ಖರೀದಿಸಿ — ಸ್ಟಾಕ್ ಕೂಡಲೇ ನಿಮಗಾಗಿ ಕಾಯ್ದಿರಿಸಲಾಗುತ್ತದೆ.', lifecycleStepThree: 'ಪರಿಶೀಲಿತ ಪಾವತಿಯ ನಂತರ ಇನ್‌ವಾಯ್ಸ್, ಆದಾಯ ಮತ್ತು ಫುಲ್ಫಿಲ್ಮೆಂಟ್ ಸಕ್ರಿಯವಾಗುತ್ತವೆ.',
  capabilities: [
  ...
  trustItems: [
    ...
    { title: 'ಸುರಕ್ಷಿತ ಪಾವತಿಗಳು', copy: 'ಸ್ಟಾಕ್ ಕಾಯ್ದಿರಿಸುವಿಕೆಯ ನಂತರ ಸರ್ವರ್-ಪರಿಶೀಲಿತ Razorpay ಪಾವತಿ.' },
...
const ml: PublicLandingCopy = {
  ...
  lifecycleKicker: 'ബന്ധിപ്പിച്ച ഓർഡർ ലൈഫ്‌സൈക്കിൾ', lifecycleTitle: 'ഉൽപ്പന്ന കണ്ടെത്തൽ മുതൽ പണമടച്ച ഫുൾഫിൽമെന്റ് വരെ—സന്ദർഭം നഷ്ടപ്പെടാതെ.', lifecycleCopy: 'ഓരോ പ്രധാന ഘട്ടവും യഥാർത്ഥ ഓർഡറുമായി ബന്ധിപ്പിച്ചിരിക്കും: സ്റ്റോക്ക് റിസർവേഷൻ, Razorpay ക്യാപ്ചർ, ഇൻവോയ്സ്, ഷിപ്പ്മെന്റ്, ട്രാക്കിംഗ്, പിന്തുണ.', lifecycleStepOne: 'ലൈവ് ഉൽപ്പന്നം കണ്ടെത്തുക അല്ലെങ്കിൽ സോഴ്‌സിംഗ് ആവശ്യം പോസ്റ്റ് ചെയ്യുക.', lifecycleStepTwo: 'ഉടനടി വാങ്ങുക — സ്റ്റോക്ക് ഉടനെ നിങ്ങൾക്കായി റിസർവ് ചെയ്യപ്പെടും.', lifecycleStepThree: 'പരിശോധിച്ച പേയ്മെന്റിന് ശേഷം ഇൻവോയ്സ്, വരുമാനം, ഫുൾഫിൽമെന്റ് സജീവമാകും.',
  capabilities: [
...
const pa: PublicLandingCopy = {
  ...
  lifecycleKicker: 'ਜੁੜਿਆ ਆਰਡਰ ਜੀਵਨਚੱਕਰ', lifecycleTitle: 'ਉਤਪਾਦ ਖੋਜ ਤੋਂ ਭੁਗਤਾਨ ਕੀਤੇ ਫੁਲਫਿਲਮੈਂਟ ਤੱਕ—ਸੰਦਰਭ ਗੁਆਏ ਬਿਨਾਂ।', lifecycleCopy: 'ਹਰ ਮਹੱਤਵਪੂਰਨ ਕਦਮ ਅਸਲੀ ਆਰਡਰ ਨਾਲ ਜੁੜਿਆ ਰਹਿੰਦਾ ਹੈ: ਸਟਾਕ ਰਾਖਵਾਂਕਰਨ, Razorpay ਕੈਪਚਰ, ਇਨਵੌਇਸ, ਸ਼ਿਪਮੈਂਟ, ਟ੍ਰੈਕਿੰਗ ਅਤੇ ਸਹਾਇਤਾ।', lifecycleStepOne: 'ਲਾਈਵ ਉਤਪਾਦ ਖੋਜੋ ਜਾਂ ਸੋਰਸਿੰਗ ਲੋੜ ਪੋਸਟ ਕਰੋ।', lifecycleStepTwo: 'ਤੁਰੰਤ ਖਰੀਦੋ — ਸਟਾਕ ਤੁਰੰਤ ਤੁਹਾਡੇ ਲਈ ਰਾਖਵਾਂ ਹੋ ਜਾਂਦਾ ਹੈ।', lifecycleStepThree: 'ਤਸਦੀਕਸ਼ੁਦਾ ਭੁਗਤਾਨ ਤੋਂ ਬਾਅਦ ਇਨਵੌਇਸ, ਕਮਾਈ ਅਤੇ ਫੁਲਫਿਲਮੈਂਟ ਸਰਗਰਮ ਹੁੰਦੇ ਹਨ।',
  capabilities: [
  ...
  trustItems: [
    ...
    { title: 'ਸੁਰੱਖਿਅਤ ਭੁਗਤਾਨ', copy: 'ਸਟਾਕ ਰਾਖਵਾਂਕਰਨ ਤੋਂ ਬਾਅਦ ਸਰਵਰ-ਤਸਦੀਕਸ਼ੁਦਾ Razorpay ਭੁਗਤਾਨ।' },
...
const ta: PublicLandingCopy = {
  ...
  lifecycleKicker: 'இணைக்கப்பட்ட ஆர்டர் வாழ்க்கைச் சுழற்சி', lifecycleTitle: 'தயாரிப்பு கண்டுபிடிப்பிலிருந்து பணம் செலுத்தப்பட்ட நிறைவேற்றம் வரை—சூழலை இழக்காமல்.', lifecycleCopy: 'ஒவ்வொரு முக்கிய கட்டமும் உண்மையான ஆர்டருடன் இணைந்தே இருக்கும்: இருப்பு ஒதுக்கீடு, Razorpay capture, இன்வாய்ஸ், ஷிப்மென்ட், கண்காணிப்பு மற்றும் ஆதரவு.', lifecycleStepOne: 'நேரடி தயாரிப்பை கண்டுபிடிக்கவும் அல்லது சோர்சிங் தேவையைப் பதிவிடவும்.', lifecycleStepTwo: 'உடனே வாங்குங்கள் — இருப்பு உடனடியாக உங்களுக்காக ஒதுக்கப்படும்.', lifecycleStepThree: 'சரிபார்க்கப்பட்ட கட்டணத்திற்குப் பிறகு இன்வாய்ஸ், வருமானம் மற்றும் நிறைவேற்றம் செயல்படும்.',
  capabilities: [
...
const te: PublicLandingCopy = {
  ...
  lifecycleKicker: 'అనుసంధానమైన ఆర్డర్ జీవచక్రం', lifecycleTitle: 'ఉత్పత్తి అన్వేషణ నుంచి చెల్లించిన ఫుల్ఫిల్మెంట్ వరకు—సందర్భం కోల్పోకుండా.', lifecycleCopy: 'ప్రతి ముఖ్యమైన దశ నిజమైన ఆర్డర్‌కే అనుసంధానంగా ఉంటుంది: స్టాక్ రిజర్వేషన్, Razorpay క్యాప్చర్, ఇన్వాయిస్, షిప్మెంట్, ట్రాకింగ్ మరియు సహాయం.', lifecycleStepOne: 'లైవ్ ఉత్పత్తిని కనుగొనండి లేదా సోర్సింగ్ అవసరాన్ని పోస్ట్ చేయండి.', lifecycleStepTwo: 'వెంటనే కొనండి — స్టాక్ వెంటనే మీ కోసం రిజర్వ్ చేయబడుతుంది.', lifecycleStepThree: 'ధృవీకరించిన చెల్లింపు తర్వాత ఇన్వాయిస్, ఆదాయం మరియు ఫుల్ఫిల్మెంట్ సక్రియమవుతాయి.',
  capabilities: [
  ...
  trustItems: [
    ...
    { title: 'సురక్షిత చెల్లింపులు', copy: 'స్టాక్ రిజర్వేషన్ తర్వాత సర్వర్-ధృవీకరించిన Razorpay చెల్లింపు.' },
