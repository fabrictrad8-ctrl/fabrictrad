...
/**
 * Ensures the configured administrator identity and canonical database profile exist.
 * No password is created or rotated here: FabricTrad administrator access is OTP-only.
 */
