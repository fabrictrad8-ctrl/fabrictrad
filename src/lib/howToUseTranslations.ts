...
const en: HowToUseCopy = {
  ...
  guide: {
    ...
    buyerSteps: [
      ...
      { title: 'Place the order', action: 'Choose the variant and quantity, then buy it straight away.', detail: 'Stock is reserved for you immediately and payment opens at once — no waiting on seller approval. An unpaid reservation is released automatically after 30 minutes.', icon: 'ShoppingBagIcon', screen: 'order' },
