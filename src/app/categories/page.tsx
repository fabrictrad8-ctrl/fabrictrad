      ...
      <div className="pt-16">
        ...
        <div className="bg-gradient-to-br from-secondary to-secondary/80 text-white py-12 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-white/80 text-base max-w-xl mx-auto">
              Explore {categories?.reduce((a, c) => a + c?.count, 0)?.toLocaleString('en-IN')}+ verified textile products across {categories?.length} categories from India&apos;s top B2B suppliers.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
          ...
          <div className="mt-10 text-center bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20 rounded-2xl p-8">
            <h2 className="text-xl font-800 text-foreground mb-2">Can&apos;t find your category?</h2>
            <p className="text-sm text-muted-foreground mb-4">
              FabricTrad connects you with 500+ verified textile suppliers across India. Browse the full marketplace or contact us.
            </p>
            <div className="flex items-center justify-center gap-3 flex-wrap">
              <Link href="/marketplace" className="btn-primary px-6 py-2.5 text-sm rounded-xl">
                Browse All Products
              </Link>
              <Link href="/buyer-registration" className="btn-secondary px-6 py-2.5 text-sm rounded-xl">
                Register as Buyer
              </Link>
            </div>
          </div>
