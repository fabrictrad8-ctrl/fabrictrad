...
export default function VerifiedEmailLoginClient() {
  ...
  useEffect(() => {
    ...
    if (authError === 'account_inactive') {
      ...
      setError('Your email was verified, but the account profile could not be completed.');
    }
  }, [searchParams]);
        ...
        <section className="hidden lg:block">
          ...
          <div className="mt-8 flex max-w-lg items-start gap-3 rounded-2xl border border-emerald-300/15 bg-emerald-300/5 p-4">
            ...
            <p className="text-xs leading-5 text-slate-400">
              There are no shared demo credentials or separate public administrator sign-in. Access requires the account inbox.
            </p>
          </div>
        </section>
