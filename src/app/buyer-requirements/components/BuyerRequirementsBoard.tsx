...
const referenceVendorMatches = [
{
  ...
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_17f90e7c3-1768573727662.png",
  confidence: 94,
...
},
{
  ...
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_12926e6f7-1784117864814.png",
  confidence: 88,
  price: '₹780 - ₹940/mtr',
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-dashed border-border bg-card py-12 text-center text-muted-foreground">
              ...
              <p className="mt-1 text-sm">
                {profile?.role === 'buyer' ? 'Your posted requirements will appear here.' : 'Open buyer requirements from live accounts will appear here.'}
              </p>
            </div>
          }
          {filtered.map((req) =>
