...
export default function FabricDrapeViewer() {
  ...
  const selectedFabric =
    PRODUCT_FABRIC_IMAGES.find((f) => f.id === selectedFabricId) || PRODUCT_FABRIC_IMAGES[0];
  ...
  const handleTouchMove = useCallback(
    (e: React.TouchEvent) => {
      ...
      setSettings((s) => ({
        ...s,
        posX: touch.clientX - dragStart.x,
        posY: touch.clientY - dragStart.y,
      }));
    },
    [isDragging, dragStart]
  );
    ...
    try {
      ...
      const response = await fetch('/api/ai/drape-on', {
        ...
        body: JSON.stringify({
          ...
          styleName:
            photoSource === 'model' ? selectedPose.description : 'the person in the uploaded photo',
          settings,
        }),
      });
      ...
      if (!response.ok || data.error) {
        throw new Error(data.error || 'AI drape generation failed');
      }
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                OpenAI image generation · On model · Upload photo · Camera selfie
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
                  ...
                  {uploadedPhoto ? (
                    <>
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Fabric will drape on your photo
                        </p>
                      </div>
                      <button
                        onClick={(e) => {
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Drape this fabric on your model or yourself
                        </p>
                      </div>
                    </>
                  )}
                ...
                <div className="space-y-3">
                  ...
                  {!cameraActive && !uploadedPhoto && (
                    ...
                    >
                      ...
                      <p className="text-xs text-muted-foreground">
                        Take a selfie to drape fabric on yourself
                      </p>
                    </button>
                  )}
        ...
        {step === 'preview' && (
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 p-3 bg-primary/5 border border-primary/20 rounded-xl">
              <Icon name="SparklesIcon" size={14} className="text-primary shrink-0" />
              <p className="text-xs text-muted-foreground">
                <span className="font-700 text-primary">OpenAI</span> will use both images to
                generate a realistic drape preview
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="relative rounded-2xl overflow-hidden bg-muted">
              {generatedImage ? (
                <AppImage
                  src={generatedImage}
                  alt="AI generated fabric drape result"
                  width={400}
                  height={600}
                  className="w-full object-cover"
                  style={{ maxHeight: 520 }}
            ...
            {aiAnalysis && (
              <div className="p-4 bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/20 rounded-2xl">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-muted-foreground ml-auto">OpenAI</span>
                </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-muted rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Surat Textile Mills · {selectedFabric.name} view
                </p>
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
            <div className="bg-card rounded-2xl border border-border p-6 max-w-sm w-full shadow-xl">
              <div className="text-center mb-5">
                ...
                <h3 className="font-800 text-foreground text-base mb-1">
