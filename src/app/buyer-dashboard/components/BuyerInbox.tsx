...
const typeConfig: Record<string, { label: string; color: string; icon: string }> = {
  product_inquiry: { label: 'Product Inquiry', color: 'ft-pill ft-pill-active', icon: 'ShoppingBagIcon' },
  requirement_response: { label: 'Requirement', color: 'ft-pill ft-pill-pending', icon: 'MegaphoneIcon' },
  post_purchase: { label: 'Post-Purchase', color: 'ft-pill ft-pill-success', icon: 'CheckCircleIcon' },
};
